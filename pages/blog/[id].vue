      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <article class="lg:col-span-8 space-y-8">
          ...
          <div class="bg-white rounded-xl shadow-sm p-8">
            ...
            <div v-if="post.content" class="prose prose-lg max-w-none mb-8">
              ...
              <div v-if="post.images?.length" class="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div v-for="image in post.images" 
                     :key="image.id" 
                     class="relative aspect-[4/3] group cursor-pointer"
            ...
            <template v-if="post.sections">
              <div v-for="section in post.sections" 
                ...
                <div v-if="section.code" 
                     class="relative bg-gray-900 rounded-xl overflow-hidden mt-4">
            ...
            <!-- Share Buttons -->
            <ShareButtons 
              :url="`https://mmorshed.me/blog/${post.slug}`"
              :title="post.title"
              class="mt-8"
            />
        ...
        <aside class="lg:col-span-4 space-y-8">
            ...
            <div class="space-y-6">
              <article v-for="relatedPost in relatedPosts" 
                ...
                <router-link :to="`/blog/${relatedPost.slug}`" 
                  ...
                  <!-- Content -->
                  <div>
                    <span v-if="relatedPost.category" 
                          :class="relatedPost.category.color || 'bg-primary-500'"
          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-2">
              <router-link v-for="category in blogCategories" 
                          :key="category.slug"
                ...
                <span :class="category.color || 'bg-primary-500'" 
...
const fetchPost = async () => {
  try {
    ...
    const response = {
      ...
      backgroundImages: [
        '/images/patterns/pattern1.svg',
        '/images/patterns/pattern2.svg'
      ],
      ...
      sections: [
        {
          ...
          images: [
            {
              url: '/images/blog/section1-1.jpg',
              caption: 'Main image'
            },
            {
              url: '/images/blog/section1-2.jpg',
              caption: 'Hover to see this image'
            }
          ]
        }
      ],
