<template>
  <div class="min-h-screen bg-white text-gray-800 font-sans">
    <div v-if="portfolioData !== null">
      <!-- Main Content -->

      <!-- Hero Section -->
      <section id="home" class="relative min-h-[calc(100vh-4rem)] flex items-center overflow-hidden py-10">
        <!-- Background -->
            ...
            <div class="lg:col-span-5">
              <div class="relative">
                ...
                <div class="relative z-10 rounded-2xl overflow-hidden shadow-xl">
                  ...
                  <NuxtPicture v-if="portfolio?.personal?.image" :src="portfolio.personal.image" :alt="portfolio.personal.name" class="w-full h-auto" />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div v-for="project in (portfolio?.projects || []).slice(0, 6)" :key="project.id"
              ...
              <div class="relative aspect-video overflow-hidden">
                ...
                <NuxtPicture v-if="project?.image" :src="project.image" :alt="project.title" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-300" />
