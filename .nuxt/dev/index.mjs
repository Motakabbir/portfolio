...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://D:/profile/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/profile/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/profile/node_modules/devalue/index.js';
import destr from 'file://D:/profile/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/profile/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/profile/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/profile/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/profile/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/profile/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/profile/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/profile/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/profile/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/profile/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/profile/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/profile/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/profile/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/profile/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file://D:/profile/node_modules/vue/index.mjs';
import { hash } from 'file://D:/profile/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/profile/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/profile/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/profile/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/profile/node_modules/@unhead/shared/dist/index.mjs';
...
const _1ckrWbBjXU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/profile";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"My personal portfolio showcasing my work and skills"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Modern Portfolio"};
...
const _lazy_MyAbrp = () => Promise.resolve().then(function () { return renderer$1; });
...
const serverAssets = [{"baseName":"server","dir":"D:/profile/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\profile","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\profile\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\profile\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\profile\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\profile\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://D:/profile/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/profile/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
